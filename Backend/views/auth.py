...
@cross_origin(origins=["https://refurbished-self.vercel.app"], supports_credentials=True)
def login():
...
@cross_origin(origins=["http://localhost:5173", "https://refurbished-self.vercel.app"], supports_credentials=True)
def google_register():
